			...
			<div id="information">
				...
				<div id ="infoSection">
					<div id="infoSectionContent">
						...
						<p><strong>This year we're featuring two awesome tracks. <em>Arcade</em> and <em>Conference</em></strong>.</p>
						
						<div id="infoLeft">
							<h4 class="hero">Whaaat!? Arcade</h4>
							<p>Do you want to come by for a bit and play some ridiculously cool games? The Whaaat!? Tabletop and Digital Arcades will be free and open 
								all day thanks to the generous support of the <a href="http://www.atlas.colorado.edu">ATLAS Institute</a> and CU Boulder's <a href="http://eef.colorado.edu">EEF</a></p>
						</div>
						
						<div id="infoRight">
							<h4 class="hero">Conference</h4>
							<p>Wanting to take a deeper dive in to what games can do? The conference portion of the Festival is limited to 175 tickets and will feature talks, workshops, panels, and tons of fun surprises.</p>
						</div>
					</div>
				</div>
					...
					<div id="infoSectionContent">
						...
						<div id="tickets">
							...
							<div class="ticketOption">
								...
								<div class="ticketPrice hero">$30</div>
								</a>
							</div>
