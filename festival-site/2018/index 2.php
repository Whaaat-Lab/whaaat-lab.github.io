			...
			<div id="information">
				...
				<div id="infoSection">
					...
					<div class="schedule">
						...
						<div class="schedule--event">
							<div class="schedule--event--title">Session 1: App Store Discoverability: On Naming, Going Free, and the Long Tail</div>
							<div class="schedule--event--description"><em>With Justin Shacklette: Data Scientist, Activision</em>: You just submitted your first mobile game...and no one can find it. Here are some awesome mistakes you can avoid and some easy tips on how to be discovered in the app store.</div>
						</div>
...
-->
						...
						<div class="schedule--event">
							<div class="schedule--event--title">Session 2: Level Design Techniques</div>
							<div class="schedule--event--description"><em>With Casey Holtz, Creative Director at Mechanical Butterfly Studios</em>: In this discussion we will cover the process of designing a level from the initial concept to completion.  We will cover techniques for paper design, pacing and difficulty ramping as well as game engine workflows that will help you design engaging levels in an efficient way while avoiding some common pitfalls.  We will try to leave time for questions and discussion at the end of the talk.  </div>
						</div>
				...
				<div id="infoSection">
					...
					<div id="speakerProfile">
						<h4>Pippin Barr</h4>
						<img class="speakerImage" src="https://2017.traceart.com.au/assets/images/_med/Pippin.png" width="400" />
						<span class="speakerBio">
				...
				<div id="infoSection">
					...
					<h3>Featured Games</h3>
						...
						<div class="gameListing">
							<h4>Closer - Marie Claire LeBlanc Flanagan</h4>
							<div class="gameDescription">Closer is an infinite scroller where you try to stay alive. But the controller is the space between two bodies. It's a continuously cooperative game.</div>
						</div>
						...
						<div class="gameListing">
							...
							<div class="gameDescription">The CU <a href="https://mediaarchaeologylab.com">Media Archeology Lab</a> has curated a special vintage videogame exhibition for Whaaat!? Featuring some vintage consoles and favorite classics from years ago, this is a rare occasion to play some amazing games including Q*bert, Zork, Contra, GoldenEye and the infamous ET on an original Commodore 64, Apple //c, Atari 2600, NES, N64, Sega Genesis, and Vextrex!</div>
						</div>
						...
						<div class="gameListing">
							...
							<div class="gameDescription">Shadowfier is a fast paced, 4 player, table top card game where players take on the role of assassins in competition working to be the last one standing. Bribe, steal, and slay on your way to victory in a game where killing your friends is simply the fun thing to do. Shadowfier was the capstone project of Blain VanNice who graduated from the TAM major in the spring of 2018</div>
						</div>					
						
						<div class="gameListing">
							<h4>SOLA - Agustina Isidori</h4>
							<div class="gameDescription">SOLA is a video game that embodies the climate of tension, discomfort and fear that can be experienced by many women while walking alone at night in cities where gender-based violence is embedded in everyday life. SOLA was developed in collaboration with Samuelle Bougault.</div>
						</div>
				...
				<div id="infoSection">
					<a name="map"></a>
					<h3>Getting to Whaaat!?</h3>
					<h4>ATLAS Institute</h4>
					<div class="gameDescription">All events at Whaaat!? (excluding lunch) will be in the ATLAS Institute at CU Boulder. Paid parking can be found in the nearby Euclid lot (underneath the CASE building), and free parking within walking distance can often be found on the Hill, west of Broadway<p></p></div>
				...
				<div id="infoSection">
					<a name="about"></a>
					<h3>About</h3>
					<div class="gameDescription">Games can be fun, and interactions can surprise you. But it takes something truly special to make you say, "Whaaat!?" 
					<p>Whaaat!? is a one-day festival for games and experimental interactions that celebrates the feeling that you get from those delightful experiences. It will feature talks, a curated arcade of experimental games, workshops, panels and more!</p>
					<p>Brought to you by the <a href="https://www.colorado.edu/atlas/?">ATLAS Institute</a> and made possible by the CU Boulder <a href="http://eef.colorado.edu">Engineering Excellence Fund</a>.</p>
					<p>Contact: festival [at] whaaat.io</p>
					</div>
				</div>
