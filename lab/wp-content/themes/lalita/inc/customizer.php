...
if ( ! function_exists( 'lalita_new_social_defaults' ) ) {
	add_filter( 'lalita_option_defaults', 'lalita_new_social_defaults', 10, 3 );
	/**
	 * Define defaults if is missing in earlier themes
	 */
	function lalita_new_social_defaults( $lalita_defaults ) {
		
		$lalita_defaults['socials_instagram_url']	 = '';
		$lalita_defaults['socials_tiktok_url']	 = '';
		$lalita_defaults['socials_twitch_url']	 = '';
		
		return $lalita_defaults;
	}
}
...
if ( ! function_exists( 'lalita_customize_register' ) ) {
	...
	function lalita_customize_register( $wp_customize ) {
			...
			$wp_customize->add_control(
				new Lalita_Customize_Misc_Control(
					...
					array(
						'section' => 'colors',
						'type' => 'addon',
						'label' => __( 'Get Lalita Premium', 'lalita' ),
						'description' => __( 'More colors are available for this section in Lalita Premium. Lalita Premium gives all premium feature for ', 'lalita' ) . esc_html( wp_get_theme() ) . __( ' and for 50 other WPKoi themes.', 'lalita' ),
						'url' => esc_url( lalita_new_theme_uri_link() ),
						'priority' => 30,
			...
			$wp_customize->add_control(
				new Lalita_Customize_Misc_Control(
					...
					array(
						...
						'type' => 'addon',
						'label' => __( 'Get Lalita Premium', 'lalita' ),
						'description' => __( 'More options are available for this section in Lalita Premium. Lalita Premium gives all premium feature for ', 'lalita' ) . esc_html( wp_get_theme() ) . __( ' and for 50 other WPKoi themes.', 'lalita' ),
						'url' => esc_url( lalita_new_theme_uri_link() ),
						'priority' => 30,
						'settings' => ( isset( $wp_customize->selective_refresh ) ) ? array() : 'blogname'
					)
		...
		$wp_customize->add_setting(
			'lalita_settings[socials_instagram_url]',
			array(
		...
		$wp_customize->add_control(
			...
			array(
				'type' 		 => 'text',
				'label'      => __( 'Instagram url', 'lalita' ),
				'section'    => 'lalita_socials_section',
				'settings'   => 'lalita_settings[socials_instagram_url]',
			)
		);
		
		$wp_customize->add_setting(
			'lalita_settings[socials_tiktok_url]',
			array(
		...
		$wp_customize->add_control(
			...
			array(
				'type' 		 => 'text',
				'label'      => __( 'TikTok url', 'lalita' ),
				'section'    => 'lalita_socials_section',
				'settings'   => 'lalita_settings[socials_tiktok_url]',
			)
		);
		
		$wp_customize->add_setting(
			'lalita_settings[socials_twitch_url]',
			array(
		...
		$wp_customize->add_control(
			...
			array(
				'type' 		 => 'text',
				'label'      => __( 'Twitch url', 'lalita' ),
				'section'    => 'lalita_socials_section',
				'settings'   => 'lalita_settings[socials_twitch_url]',
			)
		);
		...
		if ( ! defined( 'LALITA_PREMIUM_VERSION' ) ) {
			$wp_customize->add_section(
				new Lalita_Upsell_Section( $wp_customize, 'lalita_upsell_section',
					array(
						'pro_text' => __( 'Get Lalita Premium for more!', 'lalita' ),
						'pro_url' => esc_url( lalita_new_theme_uri_link() ),
