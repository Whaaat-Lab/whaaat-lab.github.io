...
function springy_admin_scripts( $hook ) {
	...
	wp_enqueue_style( 'springy-admin-style', get_template_directory_uri() . '/templatefiles/about/about.css', array(), '' );
}
	...
	<div class="das-wrap">
		<div class="springy-panel">
			<div class="springy-logo">
				<img class="ts-logo" src="<?php echo esc_url( get_template_directory_uri() . '/templatefiles/about/images/springy-logo.png' ); ?>" alt="Logo">
			</div>
			<p>
		...
		<div class="springy-panel">
			<div class="springy-panel-content">
				...
				<a href="https://smartdatasoft.com/docs/springy/" target="_blank" class="btn btn-secondary"><?php esc_html_e( 'Documentation - Click Here', 'springy' ); ?></a>
			</div>
		</div>
		<div class="springy-panel">
			<div class="springy-panel-content">
