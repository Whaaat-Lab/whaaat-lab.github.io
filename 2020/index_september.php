	...
	<body>
		<div class="grid">
			...
			<div class="gameClub ad">
				...
				Let's play games together. But in <em>secret</em>. No one will know how much we are enjoying the special game-of-the-month. And then we'll talk about those games and learn from eachother. Win win!
			</div>
			...
			<div class="robot_friend ad">Do you crave connection, but also have a big problem with real humans? Try texting a robot! It’s been programmed to be your friend, and is 55% less clingy than older models!</div>
